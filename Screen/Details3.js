...
import { back1, carote, choux, etoile, information, partager1, sac3 } from './images';
    ...
    return (
        <View style={styles.container}>
            <ScrollView showsHorizontalScrollIndicator={false}>
                ...
                <View style={{ alignItems: 'center', backgroundColor: '#e6f1ed', margin: 20, borderRadius: 10, padding: 20 }}>
                    <Image source={choux} style={styles.choux} />
                </View>
